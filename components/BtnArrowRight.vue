<template>
     <div class="transition duration-200 flex-shrink-0 button-control bg-gd-yellow-light hover:bg-gd-yellow-dark text-opacity-50 hover:text-opacity-100 text-gd-neutral-dark next">
